    ...
    <Card className="w-full max-w-md overflow-hidden transition-all duration-300 hover:shadow-2xl bg-gradient-to-br from-white via-gray-50 to-blue-50 border-none">
      <CardHeader className="p-4 sm:p-6 pb-0">
        <div className="flex flex-col sm:flex-row items-start justify-between">
          ...
          <div className="text-left sm:text-right mt-2 sm:mt-0 w-full sm:w-auto">
            ...
            <p className="text-xs sm:text-sm font-medium text-gray-600 mt-1">Seat: {seatNo}</p>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl shadow-inner">
          <div className="text-center">
            <p className="text-xs text-gray-500 mb-1">Final Amount</p>
            <p className="font-bold text-base sm:text-lg text-gray-900">${finalAmount}</p>
          </div>
          <div className="text-center border-x border-gray-100">
            <p className="text-xs text-gray-500 mb-1">Paid Amount</p>
            <p className="font-bold text-base sm:text-lg text-green-600">${paidAmount}</p>
          </div>
          <div className="text-center">
            <p className="text-xs text-gray-500 mb-1">Due Amount</p>
            <p className={`font-bold text-base sm:text-lg ${dueAmount > 0 ? 'text-red-600' : 'text-gray-900'}`}>
              ${dueAmount}
            </p>
          </div>
        </div>
