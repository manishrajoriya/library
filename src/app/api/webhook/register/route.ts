...
if (eventType === 'user.created') {
    try {
        ...
        console.log(id, email_addresses);
    ...
    try {
        ...
        return new Response('Failed to update admin', {
            status: 400,
        });
    }
    ...
    try {
        ...
        console.log(`Admin deleted with ID: ${id}`);
    } catch (error) {
        console.error('Error deleting admin:', error);
        return new Response('Failed to delete admin', {
            status: 400,
        });
    }
} else {
